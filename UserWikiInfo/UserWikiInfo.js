...
/*
* UserWikiInfo v2.1: Una colección de enlaces útiles relacionados con el usuario que aparece en contribuciones, página de usuario y discusión, con recuento de ediciones y avatar, para Monobook
* 
...
*/
var UserWikiInfo = {
	tmpl: '<div class="useravatar"><a href="/wiki/Usuario:{u}" title="Avatar de {U}"><img src="http://images4.wikia.nocookie.net/__cb20081128203240/messaging/images/thumb/1/19/Avatar.jpg/50px-Avatar.jpg" width="100" height="100" alt="Avatar" /></a></div>' +
		'<span class="userlink"><a href="/wiki/Usuario:{u}" title="Página de usuario">Usuario:{U}</a></span> &#124; <span class="talklink"><a href="/wiki/Usuario_Discusión:{u}" title="Página de discusión">Discusión</a> <a href="/index.php?title=Usuario_Discusión:{u}&amp;action=edit&amp;section=new" title="Dejar un nuevo mensaje en la página de discusión">[+]</a></span>{email} &#124; <span class="contribslink"><a href="/wiki/Especial:Contribuciones/{u}" title="Contribuciones de usuario">Contribuciones</a></span>{group}'+
	...
	dataRecv: function(data) {
		...
		var u = q.users[0].name, editcount = (q.users[0].editcount||0), groups = q.users[0].groups, emailable = (typeof q.users[0].emailable == 'string'), firstedit = (q.usercontribs.length == 0 ? '' : q.usercontribs[0].timestamp), userid = q.allusers[0].id.toString(), grouptext = '';
		...
		var shaObj = new jsSHA(userid, 'ASCII');
